...
const ICONS = {
  ...
  wifi: '<path d="M2.5 8.8a15 15 0 0 1 19 0"/><path d="M5.5 12.3a10 10 0 0 1 13 0"/><path d="M8.7 15.7a5 5 0 0 1 6.6 0"/><circle cx="12" cy="19" r="1.1" fill="currentColor" stroke="none"/>',
  network: '<path d="M4 20v-3.5M9 20v-7M14.5 20v-10.5M20 20V5"/>',
  app: '<rect x="7" y="2.8" width="10" height="18.4" rx="2.2"/><path d="M9.4 12l1.9 1.9 3.4-3.8"/>',
};
